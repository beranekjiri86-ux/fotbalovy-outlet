    ...
    <div className="grid" style={{gap:16, paddingTop:16}}>
      <div className="card">
        ...
        <p className="muted" style={{marginTop:0}}>
          Rychlé filtrování podle kategorie, stavu, velikosti (EU), značky a typu kopaček (FG/AG/SG/TF/IC).
        </p>
      ...
      <div className="grid2 grid">
        <div className="card">
          ...
          <p className="muted" style={{marginTop:0}}>
            Nejrychlejší cesta je přidat položky do košíku a odeslat objednávku (dobírka/převod), nebo zvolit „Domluva“ a napsat nám přes IG/FB.
          </p>
          <div className="row">
            <a className="btn" href={`https://instagram.com/${ig}`} target="_blank" rel="noreferrer">Napsat na Instagram</a>
            {fb ? <a className="btn" href={fb} target="_blank" rel="noreferrer">Messenger (FB)</a> : null}
            <a className="btn" href={`tel:${phone.replaceAll(" ","")}`}>Zavolat</a>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className="notice">
            ...
            <div className="small">Po odeslání objednávky se položky automaticky rezervují na 24 hodin.</div>
          </div>
        </div>
      </div>
    </div>
